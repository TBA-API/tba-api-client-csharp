...
${nuget_cmd} install src/TBAAPI.V3Client/packages.config -o packages;
...
echo "[INFO] Run 'mcs' to build bin/TBAAPI.V3Client.dll"
mcs -langversion:${langversion} -sdk:${sdk} -r:bin/Newtonsoft.Json.dll,bin/JsonSubTypes.dll,\
bin/RestSharp.dll,\
System.ComponentModel.DataAnnotations.dll,\
System.Runtime.Serialization.dll \
-target:library \
-out:bin/TBAAPI.V3Client.dll \
-recurse:'src/TBAAPI.V3Client/*.cs' \
-doc:bin/TBAAPI.V3Client.xml \
-platform:anycpu
...
then
  ...
  echo "[INFO] bin/TBAAPI.V3Client.dll was created successfully"
fi
