...
namespace TBAAPI.V3Client.Api
{
    ...
    public partial class MatchApi : IMatchApi
    {
        ...
        /// <returns></returns>
        public MatchApi(TBAAPI.V3Client.Client.Configuration configuration = null)
        {
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>ApiResponse of Match</returns>
        public ApiResponse<Match> GetMatchWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            ...
            if (matchKey != null) localVarPathParams.Add("match_key", this.Configuration.ApiClient.ParameterToString(matchKey)); // path parameter
            if (ifModifiedSince != null) localVarHeaderParams.Add("If-Modified-Since", this.Configuration.ApiClient.ParameterToString(ifModifiedSince)); // header parameter
            ...
            return new ApiResponse<Match>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Match) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Match)));
        }
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>Task of ApiResponse (Match)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Match>> GetMatchAsyncWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
                throw new ApiException(400, "Missing required parameter 'matchKey' when calling MatchApi->GetMatch");
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>ApiResponse of MatchSimple</returns>
        public ApiResponse<MatchSimple> GetMatchSimpleWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
            ...
            return new ApiResponse<MatchSimple>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (MatchSimple) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(MatchSimple)));
        }
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>Task of ApiResponse (MatchSimple)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<MatchSimple>> GetMatchSimpleAsyncWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
                throw new ApiException(400, "Missing required parameter 'matchKey' when calling MatchApi->GetMatchSimple");
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>ApiResponse of List&lt;Object&gt;</returns>
        public ApiResponse<List<Object>> GetMatchTimeseriesWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>Task of ApiResponse (List&lt;Object&gt;)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<List<Object>>> GetMatchTimeseriesAsyncWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
                throw new ApiException(400, "Missing required parameter 'matchKey' when calling MatchApi->GetMatchTimeseries");
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>ApiResponse of Zebra</returns>
        public ApiResponse<Zebra> GetMatchZebraWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
                throw new ApiException(400, "Missing required parameter 'matchKey' when calling MatchApi->GetMatchZebra");

            var localVarPath = "/match/{match_key}/zebra_motionworks";
            var localVarPathParams = new Dictionary<String, String>();
            var localVarQueryParams = new List<KeyValuePair<String, String>>();
            var localVarHeaderParams = new Dictionary<String, String>(this.Configuration.DefaultHeader);
            var localVarFormParams = new Dictionary<String, String>();
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("GetMatchZebra", localVarResponse);
                if (exception != null) throw exception;
            }

            return new ApiResponse<Zebra>(localVarStatusCode,
                localVarResponse.Headers.ToDictionary(x => x.Name, x => string.Join(",", x.Value)),
                (Zebra) this.Configuration.ApiClient.Deserialize(localVarResponse, typeof(Zebra)));
        }
        ...
        /// <param name="ifModifiedSince">Value of the &#x60;Last-Modified&#x60; header in the most recently cached response by the client. (optional)</param>
        /// <returns>Task of ApiResponse (Zebra)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Zebra>> GetMatchZebraAsyncWithHttpInfo (string matchKey, string ifModifiedSince = default(string))
        {
            // verify the required parameter 'matchKey' is set
            if (matchKey == null)
                throw new ApiException(400, "Missing required parameter 'matchKey' when calling MatchApi->GetMatchZebra");
