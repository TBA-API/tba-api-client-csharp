...
namespace TBAAPI.V3Client.Model
{
    ...
    public partial class ZebraTeam :  IEquatable<ZebraTeam>, IValidatableObject
    {
        ...
        public ZebraTeam(string teamKey = default(string), List<double> xs = default(List<double>), List<double> ys = default(List<double>))
        {
            ...
            if (teamKey == null)
            {
                throw new InvalidDataException("teamKey is a required property for ZebraTeam and cannot be null");
            }
            else
            {
            ...
            if (xs == null)
            {
                throw new InvalidDataException("xs is a required property for ZebraTeam and cannot be null");
            }
            else
            {
                this.Xs = xs;
            ...
            if (ys == null)
            {
                throw new InvalidDataException("ys is a required property for ZebraTeam and cannot be null");
            }
            else
            {
                this.Ys = ys;
